...
public interface TcItemDetailMapper {
    ...
    List<TcItemDetail> selectByExampleWithBLOBs(TcItemDetailExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") TcItemDetail record, @Param("example") TcItemDetailExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(TcItemDetail record);
